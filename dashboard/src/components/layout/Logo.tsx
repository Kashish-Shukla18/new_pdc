      ...
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="pdc-ring" x1="8" y1="4" x2="40" y2="44" gradientUnits="userSpaceOnUse">
            <stop stopColor="#4dc8f0" />
            <stop offset="0.45" stopColor="#5de8aa" />
            <stop offset="1" stopColor="#8b6cf5" />
          </linearGradient>
          <linearGradient id="pdc-wave" x1="10" y1="24" x2="38" y2="24" gradientUnits="userSpaceOnUse">
            <stop stopColor="#7ee0ff" />
            <stop offset="1" stopColor="#4dc8f0" />
          </linearGradient>
        </defs>
        ...
        <path
          ...
          fill="none"
        />
        <circle cx="24" cy="24" r="3.5" fill="#5de8aa" />
